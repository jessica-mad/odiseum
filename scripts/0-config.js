...
const SIMULATION_TICK_RATE = 1000; // 1 segundo por tick normal (velocidad x2)
const FAST_TICK_RATE = 500; // 0.5 segundos por tick veloz (el doble de rápido que el tick normal)
